...
export const spreadsheetapp_last_time_ms: (a: number) => number;
export const spreadsheetapp_new: () => number;
export const spreadsheetapp_redo: (a: number) => void;
export const spreadsheetapp_status: (a: number) => [number, number];
export const spreadsheetapp_undo: (a: number) => void;
